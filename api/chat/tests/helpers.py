...
EXPORT_FIELD_VALUES = {
    ...
    'message_date':    lambda conv, chat: chat.created_at.astimezone(ZoneInfo(conv.timezone or 'UTC')).strftime('%Y-%m-%d %H:%M:%S'),
...
BULK_EXPORT_FIELD_VALUES = {
    ...
    'created_at':       lambda conv, chat: conv.created_at.astimezone(ZoneInfo(conv.timezone or 'UTC')).strftime('%Y-%m-%d %H:%M:%S'),
    'attachment_urls':  lambda conv, chat: '',
}
