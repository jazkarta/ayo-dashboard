                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div
                      ...
                      className={`flex items-center gap-1 h-9 w-full rounded-md border bg-background px-3 text-sm cursor-text ${errors.dateOfBirth ? "border-destructive" : "border-input"} ${loading ? "opacity-50 pointer-events-none" : ""}`}
                      onClick={(e) => {
